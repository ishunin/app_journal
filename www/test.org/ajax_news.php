...
<blockquote class="quote-secondary" style="margin-top: 0px;">
              <small>* Следующие поля обязателны к заполнению: <cite title="Source Title">
              <i>Тема, Содержание Новости.</i></cite></small><br/>
...
<div class="form-group">
    ...
    <input type="text" name="Theme" maxlength="200" value="' . $theme . '" 
...
<div class="form-group">
    ...
    $output = $output . '
        ...
        <div class="form-group">
           ...
           <textarea maxlength="1000" name="Area_description" id="textarea2" class="textarea" placeholder="Краткое описание новости" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px;">' . $result['description'] . '</textarea>
         </div>
       <div class="form-group">
