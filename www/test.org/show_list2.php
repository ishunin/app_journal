...
<table id="example_main" class="table table-bordered table-striped">
  <thead>
    <tr>
      <!-- Заголовок таблицы -->
  ...
  ';
    if ($allow) {
      $edit_button = '<a class="dropdown-item" href="#" onclick="showMessage(`' . $result['ID'] . '`);" >Редактировать</a>';
      $delete_button = '<a class="dropdown-item" href="#" onclick="showMessage3(`' . $result['ID'] . '`);">Удалить</a>';
      $create_button = ' <a class="dropdown-item" href="#" onclick="showMessage2();">Создать</a>';
    } else {
      $edit_button = '';
      $delete_button = '';
      $create_button = '';
...
<!-- /btn-group -->
  ...
  <span style='font-size:12px;'><a href='one_page.php?ID=" . $ID . "' class='link-black'><i class='fas fa-share mr-1' ></i>подробнее</a></span>
      ...
      "<td>$action</td>" .
      "<td>
<div><a href='profile.php?id=$id_user' class='link-black'>" . $user_name . "</a></div>
</td>" .
      "<td>$destination</td>" .
    ...
    <div class="modal-content">
      ...
      <div class="modal-body2">
        ...
        <blockquote class="quote-secondary" style="margin-top: 0px;">
          <small>Следующие поля обязателны к заполнению: <cite title="Source Title">Содержание заявки.</cite></small>
        </blockquote>
        ...
        <form action="create.php" method="post" class="needs-validation" novalidate>
          <div class="form-group">
            ...
            <input type="text" maxlength="9" name="Jira_num" value="<?= isset($_GET['red_id']) ? $product['jira_num'] : ''; ?>" class="form-control" id="jira_num" placeholder="Номер заявки в JIRA" aria-describedby="inputGroupPrepend">
          ...
          <div class="form-group">
            <label for="destination" maxlength="15">Расположение</label>
            <input type="text" name="Destination" maxlength="60" value="<?= isset($_GET['red_id']) ? $product['destination'] : ''; ?>" class="form-control" id="destination" placeholder="Расположение" aria-describedby="inputGroupPrepend">
            <div class="valid-feedback">
          ...
          <div class="form-group">
            ...
            <textarea name="Area_content" id="textarea4" class="textarea" placeholder="Содержание заявки" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px; display: none;" required></textarea>
            <div class="valid-feedback">
              Верно
            </div>
            <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            <textarea name="Action" id="area_action" class="textarea" placeholder="Выполненные действия" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px; display: none;"></textarea>
          </div>
