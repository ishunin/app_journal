        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h4> 
                Отчет за смену 
                <?php echo '<a class="btn btn-default" href="print_report3.php?id_shift='. $id_shift.'" target="_blank" style=""><i class="fas fa-print"></i> Печать</a>'; ?>
                </h4>  
                <?php 
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-footer">
              <?php echo "<small>Всего: ".$res_mas['count']."</small>"?> 
              <a class="btn btn-default" href="print_report3.php?id_shift='. $id_shift.'" target="_blank" style="float:right;"><i class="fas fa-print"></i> Печать</a>
              </div>
              <!-- /.card-footer -->
            </div>
