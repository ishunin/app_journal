  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <!-- Вход в профиль пользователя / завершить смену -->
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item dropdown-footer">Закончить смену - Выход</a>
          </div>
        </li>
      </ul>
    </nav>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">Ишунин Дмитрий</a>
          </div>
        </div>
        <!-- Sidebar Menu -->
        <nav class="mt-2">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Журнал Эти1 - хранит инциденты при обходах</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <p>dfgdg erg eg erg</p>
