          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <img src="/dist/img/sceduler/june_21.png">
              </div>
              <!-- /.card-body -->
              <!-- /.card-header -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"></h3>
                <div class="justify-content-between" style="display: flex;">
                  График отпусков 2021
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php include("modal_close_shift.php"); ?>
                <img src="/dist/img/sceduler/holyday1.png" width="1500">
                <img src="/dist/img/sceduler/holyday2.png" width="1500">
