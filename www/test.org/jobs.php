...
<head>
  ...
  <title>Журнал ЭТИ№1 - Работы</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h4><i class="fas fa-wrench"></i> Задания</h4>
            </div>
            <div class="col-sm-6">
      ...
      <section class="content">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <div class="justify-content-between" style="display: flex;">
                  <a class="btn btn-default" href="#" onclick="showMessage2();">Создать</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php
                include "show_jobs.php"
                ?>
              </div>
              <!-- /.card-body -->
            </div>
                    ...
                    <div class="tab-pane fade active show" id="custom-content-below-home" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                      <div class="row" style="margin-bottom:10px;">
                        <div class="col-12">
                          ...
                          <?php include("show_last_comments_jobs.php"); ?>
                        </div>
                      </div>
                    </div>
                    <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
                          <?php
                            echo(print_all_jobs_changes ($link,0));
                          ?>
                    </div>
                  </div>
                </div>
            ...
            <?php //include("show_add_panel_jobs.php"); ?>
