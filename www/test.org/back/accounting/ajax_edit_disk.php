...
?>   
    ...
    <div class="form-group">
      ...
      <input type="text" maxlength="30" name="serial_num" value="<?php echo($serial_num);?>" class="form-control" id="serial_num" placeholder="Серийны номер диска" aria-describedby="inputGroupPrepend" >
    ...
    <div class="form-group">
      ...
      <input type="text" maxlength="10" name="inc" value="<?php echo($inc);?>" class="form-control" id="ibs_num" placeholder="Номер заявки в IBS" aria-describedby="inputGroupPrepend">
        <div class="valid-feedback">
            Верно (при остутствии номера заявки автоматически поле помечается как "б/н")
        </div>
        <div class="invalid-feedback">
    ...
    <div class="form-group">
      ...
      <textarea name="comment" id="comment_simple_textare" class="textarea" required placeholder="Комментарий. *Обязательно для заполнения при редактированииююю" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px;" ><?php echo $comment;?></textarea>
