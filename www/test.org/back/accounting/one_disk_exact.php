    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active" ><a href="/accounting/overall_disks.php">ZIP</a></li>

                <?php
                if (isset($_GET['cart']) && $_GET['cart']==1) {
                  $str_ref = "<a href='\accounting\cart.php'>В корзину</a>";
                }
                else {
                  $ref = $_SERVER['HTTP_REFERER'];
                  $str_ref = "<a href='".$ref."'>Описание диска</a>"; 
                }
                ?>
                <li class="breadcrumb-item active"><?php echo $str_ref; ?></li>
                <li class="breadcrumb-item active"><?php if (isset($_GET['id']) && !empty($_GET['id'])) { echo (get_disk_serial_by_id($link_account,$_GET['id']));} else {echo 'нет2';} ?></li>
      ...
      <section class="content">
        <div class="row">
          <div class="col-12">
            <?php
            include ("show_one_disk_exact.php");
            ?>
          </div>
          <!-- /.col -->
        </div>
