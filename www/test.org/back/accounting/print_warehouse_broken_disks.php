...
<head>
  ...
  <title>Журнал ЭТИ№1 - Диски на складе</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h4>Диски на складе сломанные</h4>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/index.php">Главная</a></li>
                <li class="breadcrumb-item active">Все диски на складе сломанные</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <div class="row">
          <div class="col-12">
            <?php
            include ("show_warehouse_broken_disk.php");
            ?>
          </div>
          <!-- /.col -->
        </div>
