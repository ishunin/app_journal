...
if (isset($_GET['search_type']) && $_GET['search_type']==1) {
 ...
 <blockquote class="quote-secondary" style="margin-top: 0px;">
  ...
  foreach ( $mas as $value ) {
      ...
      while ($res3 = mysqli_fetch_array($sql3)) {
        $count++; 
        $sql_user = mysqli_query($link, "SELECT `ID`,`first_name`, `last_name` FROM `users` WHERE `ID`=".$res3['id_user']."");
                    ...
                    <div class="active tab-pane" id="activity">
                      ...
                      <div class="post">
                        <div class="user-block">
                          ...
                          <span class="description">Опубликованно - '.$res3['create_date'].'</span>
                        </div>
                        <!-- /.user-block -->
                        <div style="clear: left"></div>
                        <h3>'.choose_color($res3['jira_num'], $search, "khaki").'</h3>
                        <div clea
                        <p>
                           '.choose_color($content, $search, "khaki").'
                        </p>
                        <p>
                          <a href="one_page.php?ID='.$res3['ID'].'" class="link-black text-sm mr-2"><i class="fas fa-share mr-1"></i> Перейти</a>
                        </p>
                      </div>
                      <!-- /.post -->  
  ';
  ...
  <div class="tab-content">
                    <div class="active tab-pane" id="activity">
                      ...
                      <div class="post">
                        ...
                        <!-- /.user-block -->
                        <h3>'.choose_color($result['jira_num'], $search, "khaki").'</h3>
                        <p>
                           '.choose_color($result['content'], $search, "khaki").'
                        </p>
                        <p>
                          <a href="one_page.php?ID='.$result['ID'].'" class="link-black text-sm mr-2"><i class="fas fa-share mr-1"></i> Перейти</a>
                        </p>
                      </div>
                      <!-- /.post -->  
  ';
