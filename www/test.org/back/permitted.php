          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Доступ запрещен</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12"> 
                <div class="alert alert-danger alert-dismissible">
                  ...
                  <h5><i class="icon fas fa-ban"></i> Отказано</h5>
                  <p>Пользователю запрещен доступ к данной странице.</p>
                  <?php 
                  if (isset($_GET['level'])){
                 // echo ("<p>Необходим уровень доступа - ".get_access_level_by_id($_GET['level'])."</p>"); 
                  echo ("<p>Ваш уровень доступа - ".get_access_level_by_id($_COOKIE['user_level'])." - обратитесь к системному администратору для повышения.</p>"); 
                  }
                  ?> 
                  </p>
                  <h5><a href="#" onclick="history.back();"> Вернуться назад </a></h5>
