...
$sql = mysqli_query($link, "SELECT *  FROM `news`  WHERE  create_date >= '$last_login' AND create_date <= '$current_login' ORDER BY create_date DESC") ;
if ($sql) {
$count=0;
...
echo '
                    ...
                    <div class="post">
                      ...
                      <p>
                        ...
                        <a href="#" class="link-black text-sm mr-2" onclick="showMessage5_news('.$result['ID'].','.$_GET['page'].');"> <i class="far fa-folder-open"></i> Открыть</a>
                        <a href="#" class="link-black text-sm mr-2" onclick="showMessage_news('.$result['ID'].','.$_GET['page'].');"> <i class="far fa-edit"></i> Редактировать</a>
                  
                        <a href="#" class="link-black text-sm mr-2" onclick="showMessage3_news('.$result['ID'].');"> <i class="fas fa-trash"></i> Удалить</a>
                        <span class="float-right">
                          <a href="#" onclick="showMessage4_news('.$result['ID'].')"; class="link-black text-sm">
...
function showMessage4_news(id) {
 ...
 $('#modal-default3_news').modal({show:true});
});
  }
...
function showMessage2_news() {
 $('#modal-default_news').modal({show:true});
//});
}
</script>
...
function showMessage_news(id,page) {
 ...
 $('#modal-default2_news').modal({show:true});
});
  }
...
$('#modal-danger_news').modal({show:true});
$('#del_id_news').val(id);
