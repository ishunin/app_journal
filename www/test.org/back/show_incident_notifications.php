...
$count_incidents=0;
$sql = mysqli_query($link, "SELECT *  FROM `list`  WHERE id_shift=$last_shift_id AND Create_date >= '$last_login' AND Create_date <= '$current_login' ORDER BY Create_date DESC LIMIT 10") ;
if ($sql) {
   ...
   while ($result = mysqli_fetch_array($sql)) {
    ...
    <div class='media'>
      ...
      <div class='media-body'>
       ...
       <p class='text-sm'> <small>$content</small></p>
