...
/*
if(($userdata['users_hash'] === $_COOKIE['hash']) && ($userdata['ID'] === $_COOKIE['id'] 
...
$action=substr($result['action'],0,200);
          ...
          <div class="callout callout-info">
                ...
                <form action="create.php" method="post" class="needs-validation" novalidate>
                  <div class="form-group">
                    ...
                    <input type="text" maxlength="8" name="Jira_num" value="<?= isset($_GET['red_id']) ? $product['jira_num'] : ''; ?>" 
                    class="form-control" id="jira_num" placeholder="Номер заявки в JIRA" aria-describedby="inputGroupPrepend">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="Destination" maxlength="60" value="<?= isset($_GET['red_id']) ? $product['destination'] : ''; ?>" 
                    class="form-control" id="destination" placeholder="Расположение" aria-describedby="inputGroupPrepend">
                    <div class="valid-feedback">
