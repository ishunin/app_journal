    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h4> График смен дежурных ЭТИ №1</h4>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/index.php">Главная</a></li>
                <li class="breadcrumb-item active">График</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="justify-content-between" style="display: flex;">
                 График за Октябрь 2020
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <?php include ("modal_close_shift.php"); ?>
                <img src="/dist/img/sceduler/october.png">
              </div>
              <!-- /.card-body -->
              <!-- /.card-header -->
