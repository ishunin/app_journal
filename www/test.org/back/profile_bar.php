 <li class="nav-item dropdown">
           <a href="#" class="nav-link" data-toggle="dropdown">
              ...
              <img src="<?php $_SERVER['DOCUMENT_ROOT'];?>/dist/img/<?php echo($_COOKIE['id']);?>.png" class="user-image" alt="User Image">
 ...
 <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?php $_SERVER['DOCUMENT_ROOT'];?>/profile.php" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">        
              <img src="<?php $_SERVER['DOCUMENT_ROOT'];?>/dist/img/<?php echo($_COOKIE['id']);?>.png" alt="User Avatar" class="img-size-50 mr-3 img-circle">            
