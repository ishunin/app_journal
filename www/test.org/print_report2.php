          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h4> 
                ...
                if ($shif_info!=0) {           
                echo '<small><a href="profile.php?id='.$shif_info['id_user'].'" class="link-black"><img class="img-circle elevation-2" src="'.get_user_icon($shif_info['id_user'],$link).'"> '. get_user_name_by_id( $shif_info['id_user'],$link).' </a> <u><b>'.$shif_info['create_date'].' - '.$shif_info['end_date'].'</u></b> </small>';
                }
                ?>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-footer">
              <a class="btn btn-default" href="print_report2.php" target="_blank"><i class="fas fa-print"></i> Печать</a>
              </div>
              <!-- /.card-footer -->
            </div>
