...
<head>
  ...
  <title>Журнал ЭТИ№1 - Смены</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h4><i class="fas fa-exchange-alt"></i> Смены</h4>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/index.php">Главная</a></li>
                <li class="breadcrumb-item active">Смены</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Список смен:</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php
                ...
                include "show_shifts.php"
                ?>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            <?php include("show_add_panel_shifts.php"); ?>
          </div>
          <!-- /.col -->
        </div>
        <!-- /.row -->
