...
<!-- required; -->
<form action="add_disk_art.php" method="post" class="needs-validation" novalidate>
  ...
  <div class="modal-body">
    ...
    <label>Фирма</label>
      ...
      <option value="">KraftWay</option>
      <option value="">CSICO</option>
    ...
    <label>Фирма</label>
      ...
      <option value="">SAS SP</option>
      <option value="">SATA</option>
      <option value="">SCSI</option>
      <option value="">FC</option>
      <option value="">FC DP</option>     
      </select>
      <div class="valid-feedback">
          Верно 
        </div>
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
             <input type="checkbox" class="custom-control-input" id="customSwitch2" name="monitor" onclick="showHide('treshold')">
