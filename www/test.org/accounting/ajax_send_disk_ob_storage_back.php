...
<form action="/accounting/send_disk_ob_storage_back.php" method="post">
  <div class="modal-header">
    <h4 class="modal-title">Уверены что хотите вернуть диск в работу?</h4>
  ...
  <small>*Диск будет больше не будет числиться на хранении на складе ОБ</small>
  ...
  <div class="modal-footer justify-content-between">
    ...
    <button type="submit" class="btn btn-outline-light">Вернуть в работу</button>
  </div>
</form>