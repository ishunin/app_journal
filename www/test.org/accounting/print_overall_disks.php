          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a  class="btn btn-default" href="print_all_incidents.php" target="_blank" ><i class="fas fa-plus"></i> Создать новую номенклатуру диска</a>
                <a  class="btn btn-default" style="float:right;" href="print_all_incidents.php" target="_blank" ><i class="fas fa-print"></i> Печать</a>

              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php include("show_disks.php");?>
              </div>
              <!-- /.card-body -->
              <!-- /.card-header -->
