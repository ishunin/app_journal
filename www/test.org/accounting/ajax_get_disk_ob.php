...
<form action="/accounting/get_disk_ob.php" method="post">
  <div class="modal-header">
    <h4 class="modal-title">Уверены что вы уже забрали диск на склад?</h4>
  ...
  <div class="modal-footer justify-content-between">
    ...
    <button type="submit" class="btn btn-outline-light">Забрать на склад</button>
  </div>
</form>