...
<head>
  ...
  <title>Журнал ЭТИ№1 - Сводная по дискам</title>
...
<body class="hold-transition sidebar-mini">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">ZIP</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                if ($is_allowed_button) {
                  echo ('<a  class="btn btn-default" href="#" onclick="add_disk_templ();"><i class="fas fa-plus"></i> Создать новую номенклатуру диска</a>');
                } else {
                  echo '<small>* Требуется повышение прав для создания шаблона диска</small>';
                }
                ?>
                <a class="btn btn-default" style="float:right;" href="print_overall_disks.php" target="_blank"><i class="fas fa-print"></i> Печать</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php
                include("show_disks.php");
                include("modal_exec.php");
                ?>
              </div>
              <!-- /.card-body -->
              <!-- /.card-header -->
            ...
            <!-- /.card -->
            <?php
            include("show_add_panel_zip.php")
            ?>
          </div>
          <!-- /.col -->
        </div>
  ...
  <?php
  include('modal_del_disk_templ.php');
