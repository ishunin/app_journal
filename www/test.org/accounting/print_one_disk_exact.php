          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo($_SERVER['HTTP_REFERER']);?>">Описание диска</a></li>
                <li class="breadcrumb-item active"><?php echo (get_disk_serial_by_id($link_account,$_GET['id']));?></li>
