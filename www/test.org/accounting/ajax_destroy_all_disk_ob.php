...
<form action="/accounting/destroy_all_disk_ob.php" method="post">
  <div class="modal-header">
    <h4 class="modal-title">Уверены что хотите уничтожить ВСЕ диски из списка на уничтожение?</h4>
  ...
  <div class="modal-footer justify-content-between">
    ...
    <button type="submit" class="btn btn-outline-light">Уничтожить все диски</button>
  </div>
</form>