 ...
 <table id="example1" class="table table-bordered table-striped">
     ...
     <?php
        $sql = mysqli_query($link_account, "SELECT *  FROM `disk_balance` WHERE `status`=1 AND `state`=1 AND `deleted`=0 ORDER BY `date` DESC LIMIT 100");
        echo '<tbody>';
