...
<head>
  ...
  <title>Журнал ЭТИ№1 - Панель учета дисков</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h4>Панель учета дисков</h4>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/index.php">Главная</a></li>
                <li class="breadcrumb-item active">Панель учета дисков</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="justify-content-between" style="display: flex;">
                  Диски на мониторинге
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php include("show_monitor_disks.php"); ?>
              </div>
              <!-- /.card-body -->
              <!-- /.card-header -->
