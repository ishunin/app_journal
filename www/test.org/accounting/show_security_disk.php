    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Все диски на в отделе безопасности</h3>
          <a class="btn btn-default" style="float:right;" href="print_security_disks.php" target="_blank"><i class="fas fa-print"></i> Печать</a>
        </div>
        <div class="card-body">
          <?php
          include("table_disk_security.php");
          ?>
        </div>
        <!-- /.card-body -->
        <div class="card-footer">
        <a class="btn btn-default" href="#" onclick="send_all_disk_ob_storage();"><i class="fas fa-share"></i> Забрать все диски на склад</a>
        </div>
        <!-- /.card-footer-->
      </div>
      <!-- /.card -->
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Все диски на в отделе безопасности на хранении</h3>
          <a class="btn btn-default" style="float:right;" href="print_security_disks.php" target="_blank"><i class="fas fa-print"></i> Печать</a>
        </div>
        <div class="card-body">
          <?php
