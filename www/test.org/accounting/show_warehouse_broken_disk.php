    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">*Эти диски нужно отнести в ОБ для уничтожения</h3>
          <a class="btn btn-default" style="float:right;" href="print_warehouse_broken_disks.php" target="_blank"><i class="fas fa-print"></i> Печать</a>
        </div>
        <div class="card-body">
          <?php
          include("table_broken_disk_warehouse.php");
          ?>
        </div>
        <!-- /.card-body -->
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">*Эти диски уже уничтожены, их нужно передать в IBS</h3>
          <a class="btn btn-default" style="float:right;" href="print_warehouse_broken_disks.php" target="_blank"><i class="fas fa-print"></i> Печать</a>
        </div>
        <div class="card-body">
          <?php
          include("table_killed_disk_warehouse.php");
          ?>
        </div>
        <!-- /.card-body -->
        <div class="card-footer">
