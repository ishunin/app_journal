...
<form action="/accounting/forgive_disk.php" method="post">
  <div class="modal-header">
    <h4 class="modal-title">Уверены что хотите списать диск?</h4>
  ...
  <div class="modal-footer justify-content-between">
    ...
    <button type="submit" class="btn btn-outline-light">Списать диск</button>
  </div>
</form>