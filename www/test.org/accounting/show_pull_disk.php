    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">* Здесь отображаются все операции по расходу дисков в ЦОД по каждому диску.</h3>
          <a class="btn btn-default" style="float:right;" href="print_push_disks.php" target="_blank"><i class="fas fa-print"></i> Печать</a>
        </div>
        <div class="card-body">
          <?php
          include("table_disk_pull.php");
          ?>
        </div>
        <!-- /.card-body -->
