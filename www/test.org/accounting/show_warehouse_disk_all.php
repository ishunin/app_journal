    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Все диски на складе</h3>
          <a class="btn btn-default" style="float:right;" href="print_warehouse_disks.php" target="_blank"><i class="fas fa-print"></i> Печать</a>
        </div>
        <div class="card-body">
          <?php
          include("table_disk_warehouse_all.php");
          ?>
        </div>
        <!-- /.card-body -->
