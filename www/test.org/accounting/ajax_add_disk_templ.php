...
<form action="add_disk_templ.php" method="post" class="needs-validation" novalidate>
  ...
  <div class="modal-body">
    ...
    <label>Интерфейс</label>
      ...
      <option value="SAS2">SAS2</option>
      <option value="SAS SP">SAS SP</option>
      <option value="SAS DP">SAS DP</option>
    ...
    <label>Объем, Гб.</label>
     ...
     <div class="form-group">
      ...
      <input type="text" maxlength="90" name="part_number" value="" class="form-control" id="name" placeholder="Парт-номер" aria-describedby="inputGroupPrepend" required>
        <div class="valid-feedback">
          Верно 
        </div>
        <div class="invalid-feedback">
    ...
    <label>Порог для мониторинга, шт.</label>
      <select class="custom-select" name="treshold" >
