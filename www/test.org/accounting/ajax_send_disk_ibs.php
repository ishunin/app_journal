...
<form action="/accounting/send_disk_ibs.php" method="post">
  <div class="modal-header">
    <h4 class="modal-title">Уверены что хотите передать диск в IBS?</h4>
  ...
  <div class="modal-footer justify-content-between">
    ...
    <button type="submit" class="btn btn-outline-light">Передать в IBS</button>
  </div>
</form>