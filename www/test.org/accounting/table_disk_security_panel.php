 ...
 <table id="example1_ob" class="table table-bordered table-striped " data-sort-name="date" data-sort-order="desc">
   <thead>
     <tr>
       <!-- Заголовок таблицы -->
   ...
   <?php
    $sql = mysqli_query($link_account, "SELECT *  FROM `disk_balance` WHERE `status`=4 AND `deleted`=0 ORDER BY `date` DESC LIMIT 100");
    echo '<tbody>';
