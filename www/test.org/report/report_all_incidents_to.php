...
$jql = 'project = INM AND issuetype = Incident AND status in ("Внешняя линия") AND INM-ERROR = "Систем мониторинга" AND reporter in (duty_it, currentUser(), membersOf("Администраторы серверного оборудования"), pserver_admins)';
